...
export const FALLBACK_VIDEOS: Record<string, Video[]> = {
  'Global Warming': [
    ...
    {
      id: 'dcBXmj1nMTQ',
      title: 'Global Warming and Climate Change - Explained (Animation)',
  ...
  'Glacial Melting': [
    ...
    {
      id: 'ujkcTZZBIIE',
      title: 'Climate Change: The Melting of Antarctica | National Geographic',
  ...
  'Ozone Layer Depletion': [
    {
      id: 'CaLOiGEDPJQ',
      title: 'Ozone Layer Depletion | #aumsum #kids #science',
    ...
    {
      id: '3HaCqoaIT6g',
      title: 'The Ozone Layer Recovery Success Story | DW Planet A',
  ...
  'Desertification': [
    {
      id: 'q4c1a3atqjo',
      title: 'Desertification: The people fighting to stop the spread of the Sahara | DW Documentary',
    ...
    {
      id: 'OrFN35x1JoQ',
      title: 'What is Desertification? | Science ABC',
  ...
  'Coral Reef Destruction': [
    {
      id: 'aGGBGcB4_N8',
      title: 'Why are coral reefs dying? | DW Planet A',
  ...
  'Loss of Biodiversity': [
    {
      id: 'ua-jvWD6iYI',
      title: 'Biodiversity Loss: The Extinction Crisis | DW Documentary',
    ...
    {
      id: 'GK_vRtHJZu4',
      title: 'What is Biodiversity? | Science ABC',
  ...
  'E-waste Mismanagement': [
    {
      id: 'ITwYH4UOeM4',
      title: 'E-waste: The world\'s growing environmental crisis | DW Documentary',
    ...
    {
      id: '4L0tLY8HTpc',
      title: 'What happens to your old electronics? | Science ABC',
  ...
  'Refugee Crisis': [
    {
      id: 'yRPVT6ZpMzs',
      title: 'Climate Refugees: The Global Crisis | DW Documentary',
    ...
    {
      id: 'wC6DX6VLnFg',
      title: 'Environmental Migration Explained | Science ABC',
  ...
  'Permafrost Thawing': [
    {
      id: '9GZx3P3PY_A',
      title: 'Thawing Permafrost: A Sleeping Giant? | DW Planet A',
    ...
    {
      id: 'y7ZoeBHyG1c',
      title: 'What is Permafrost? | Science ABC',
  ...
  'Antarctica Melting': [
    {
      id: 'Z1w5tSzJ_dk',
      title: 'Antarctica: The Melting Continent | DW Documentary',
    ...
    {
      id: 'pJ1U0RGPDgY',
      title: 'Antarctica\'s Ice Sheets Explained | Science ABC',
...
// Function to get fallback videos for a category
export const getFallbackVideos = (category: string): Video[] => {
  if (category === 'All Topics') {
    return Object.values(FALLBACK_VIDEOS).flat();
  }
